...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/13 14:18:49 by anyo              #+#    #+#             */
/*   Updated: 2018/04/06 16:00:59 by anyo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	hist_exists(t_hist **head, char *input)
{
	t_hist	*node;
...
int			hist_append(t_hist **head, char *input)
{
	...
	if (ft_strisblank(input) == TRUE || hist_exists(head, input) == TRUE)
		return (EXIT_SUCCESS);
