...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/27 13:41:25 by anyo              #+#    #+#             */
/*   Updated: 2018/04/06 17:15:46 by anyo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	input_add_heredocs(char **input, char ***heredocs)
{
	int	ret;
...
int			input_catch(char **input, char ***heredocs)
{
	...
	return (input_add_heredocs(input, heredocs));
}
